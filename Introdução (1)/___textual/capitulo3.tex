...
No aprendizado supervisionado, o modelo é treinado a partir de pares entrada-saída $(x_{i},y_{i})$, buscando estimar uma função $f:x\mapsto y$ que minimize o erro entre a resposta predita e a real paradigma mais adequado ao contexto deste trabalho \cite{Bishop2006}. A Figura~\ref{fig:camada} apresenta um modelo multicamadas de neurônios artificais.

\begin{figure}
    \centering
    \caption{Modelo de neurônio artificial.}
    \includegraphics[width=12cm]{figuras/camadas.png}
    \\\autoria{\citeonline{furtado2019}.}
    \label{fig:camada}
\end{figure}
