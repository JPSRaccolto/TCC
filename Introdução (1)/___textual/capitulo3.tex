...
Para uma compreensão estruturada, a Tabela \ref{tab:comparativo_arq} ilustra as diferenças que definem a adequação destas arquiteturas aos projetos de eletrônica embarcada.

\begin{table}[!h]
\centering
\caption{Comparativo entre as Arquiteturas de Von Neumann e Harvard}
...
\textbf{Complexidade de \textit{Hardware}} & Menor, resultando em \textit{chips} de silício menores. & Maior, devido à duplicação da malha de roteamento. \\
\textbf{Paradigma de Instruções} & Frequentemente associado a arquiteturas \textit{CISC}. & Tipicamente associado a arquiteturas \textit{RISC}. \\
