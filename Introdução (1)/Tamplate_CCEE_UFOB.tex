...
\documentclass[ptcc,digital]{CorujaTex}
...
\titulo{Sistema embarcado para monitoramento e análise de grandezas elétricas com aplicação de machine learning}
%\subtitulo{coloque o subtítulo, se houver}

% Autor
% e.g. \author{Thomas Edison}
\autor{João Pedro Soares Raccolto}
...
\orientador{Prof. Dr. Manoel Messías Silva Júnior}
...
\begin{document}
	...
	\include{___textual/capitulo1}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo2}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo3}
	\newpage \thispagestyle{empty}
	
	\include{___textual/capitulo4}
	\newpage \thispagestyle{empty}
	
	%\include{___textual/capitulo5}
	%\newpage \thispagestyle{empty}
	
	%\include{___textual/capitulo6}
	%\newpage \thispagestyle{empty}
